...
/*   Updated: 2018/05/17 14:31:24 by lballiot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf("\nMODIF\n");
//	printf("data->zoom = %d\n", data->zoom);
	data->width_win = (100 + 10) * data->len_map;//(data->zoom + 10) * data->len;
	data->height_win = (100 + 10) * data->height_map;//(data->zoom + 10) * data->height;
